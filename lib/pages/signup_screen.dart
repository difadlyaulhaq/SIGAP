      ...
      child: Column(
        ...
        children: [
          ...
          _buildMedicalSection(
            ...
            onSelectionChanged: (selected) {
              setState(() {
                ...
                // If "Tidak ada alergi" is selected, clear other selections
          ...
          _buildMedicalSection(
            ...
            onSelectionChanged: (selected) {
              setState(() {
                ...
                // If "Tidak ada riwayat penyakit" is selected, clear other selections
          ...
          _buildMedicalSection(
            ...
            onSelectionChanged: (selected) {
              setState(() {
                ...
                // If "Tidak konsumsi obat rutin" is selected, clear other selections
          ...
          Container(
            ...
            child: Row(
              children: [
                Icon(Icons.security_outlined, color: primaryColor),
                const SizedBox(width: AppSpacing.sm),
                Expanded(
                  child: Text(
                    'Data riwayat kesehatan Anda akan disimpan dengan aman dan hanya digunakan untuk keperluan medis darurat.',
        ...
        children: [
          ...
          Wrap(
            ...
            children: options.map((option) {
              ...
              bool isNoneOption = option.contains('Tidak ada') || option.contains('tidak');
              ...
              return GestureDetector(
                onTap: () {
                  ...
                  if (isNoneOption) {
                    // If selecting a "none" option, clear all and select only this
                    newSelection = [option];
                  } else {
                    // If selecting a specific condition
                    if (isSelected) {
                      newSelection.remove(option);
                    } else {
                      // Remove "none" options if they exist
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: isSelected 
                        ? (isNoneOption ? accentColor.withOpacity(0.1) : primaryColor.withOpacity(0.1))
                        : backgroundLight,
                    borderRadius: smallRadius,
                    border: Border.all(
                      color: isSelected 
          ...
          if (selectedItems.isNotEmpty && selectedItems.any((item) => !item.contains('Tidak ada') && !item.contains('tidak')))
            Padding(
        ...
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              Text(
                'Registrasi Berhasil!',
                style: headingMediumTextStyle.copyWith(color: successColor),
    ...
    return Column(
      ...
      children: [
        ...
        TextFormField(
          ...
          obscureText: isPassword && (isPassword ? !_isPasswordVisible && !_isConfirmPasswordVisible : false),
          ...
          children: _genderOptions.map((gender) {
            ...
            return Expanded(
              child: GestureDetector(
                ...
                child: Container(
                  margin: EdgeInsets.only(right: gender != _genderOptions.last ? AppSpacing.sm : 0),
                  padding: const EdgeInsets.symmetric(vertical: AppSpacing.md),
                  decoration: BoxDecoration(
              ...
              children: [
                ...
                Text(
                  _selectedDate != null
                      ...
                      : 'Pilih tanggal lahir',
                  style: bodyMediumTextStyle.copyWith(
                    color: _selectedDate != null ? textPrimaryColor : textTertiaryColor,
                  ),
                ),
                const Spacer(),
        ...
        children: [
          if (_currentStep > 0)
            Expanded(
              child: OutlinedButton(
                ...
                child: Text(
                  'Sebelumnya',
                  style: buttonMediumTextStyle.copyWith(color: textSecondaryColor),
                ),
              ),
            ),
          ...
          Expanded(
            ...
            child: Container(
              ...
              child: ElevatedButton(
                onPressed: _isLoading ? null : (_currentStep == 3 ? _handleSignup : _nextStep),
                style: ElevatedButton.styleFrom(
